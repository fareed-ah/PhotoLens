...
let UserResolver = class UserResolver {
    ...
    registerUser(firstName, lastName, email, password, { em, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = em.create(User_1.User, { firstName: firstName, lastName: lastName, email: email, password: hashedPassword });
            try {
    ...
    updateUser(id, firstName, lastName, email, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    ...
    __param(1, type_graphql_1.Arg('last_name', () => String)),
    __param(2, type_graphql_1.Arg('email', () => String)),
    __param(3, type_graphql_1.Arg('password', () => String)),
...
__decorate([
    ...
    __param(0, type_graphql_1.Arg('id', () => type_graphql_1.Int)),
    __param(1, type_graphql_1.Arg('first_name', () => String)),
    __param(2, type_graphql_1.Arg('last_name', () => String)),
